...
const PRODUCTS: Product[] = [
    ...
    { id: '5', name: 'Meguiars Ultimate All Wheel Cleaner', description: 'surface cleaner, Non-greasy formula', price: 5500, rating: 4.5, reviews: 198, image: require('../assets/marketplace/interior_detailer_spray.webp'), category: 'Cleaning Solutions', unit: '710 ml' },
    { id: '6', name: 'Electric Car Polishing Machine', description: 'Variable speed, ergonomic design', price: 21000, rating: 4.9, reviews: 678, image: require('../assets/marketplace/dual_action_polisher.jpg'), category: 'Equipment', unit: '700W' },
    { id: '7', name: 'Karcher High Pressure washer', description: '2000 PSI, includes accessories', price: 58000, rating: 4.8, reviews: 892, image: require('../assets/marketplace/portable_pressure_washer.jpg'), category: 'Equipment' },
    { id: '8', name: 'Wet and Dry Vacuum Cleaner', description: '6.5 HP, 16 gallon capacity', price: 25000, rating: 4.7, reviews: 445, image: require('../assets/marketplace/wet_dry_vacuum.jpg'), category: 'Equipment' },
    { id: '9', name: 'Car Washing Foam Gun', description: 'Adjustable spray pattern, fits most washers', price: 3000, rating: 4.8, reviews: 734, image: require('../assets/marketplace/foam_cannon_pro.webp'), category: 'Equipment' , unit: '700 ml'},
